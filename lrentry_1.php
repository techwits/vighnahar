...
?>
		...
		<div class="form-group">
			...
			<div class="input-group">
				<select name="consigneeid" id="consigneeid" class="form-control" tabindex="-1" aria-hidden="true" onchange="return get_productOnConsignee(this.value, <?php echo $ConsignorID; ?> , <?php echo $session_userid; ?>, '<?php echo $session_ip; ?>');">
					<option></option>
					<?php

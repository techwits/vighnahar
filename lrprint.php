		...
		<div class="table-responsive">
			<table>
				...
				<tr>
					...
					<?php
					$Total=0;
					$Total=$Split_AdditionalCharges[0]+$Split_AdditionalCharges[1]+$Split_AdditionalCharges[2]+$Split_AdditionalCharges[3]+$Split_AdditionalCharges[4]+$Split_AdditionalCharges[5]+$Split_AdditionalCharges[6];
					?>

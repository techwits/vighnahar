...
//														echo("FinancialYear :- $FinancialYear </br>");
									...
									<div class="col-xs-2 text-center col-lg-offset-1">
										<div class="label label-danger" style="padding: 15px; font-size:24px;">
											...
											<div>
                                            	<div class="text-size-small">Total Amount</div>
											</div>

											<span id="div_paidlramount"></span>
										</div>
									</div>
								</div>
								...
								<div class="row extra-bottom-padding">
									...
									<div class="col-md-3">
										<div class="form-group form-group-material">
											...
											<div class="input-group">
												<select name="consignorid" id="consignorid" required  class="form-control" onchange="return get_consignee(this.value, <?php echo $_SESSION['user_id']; ?>, '<?php echo $_SESSION['ip']; ?>');" onblur="return lrentry_disabled(this.value, 'consignorid');">
													<option></option>
													<?php
													Fill_Consignor($con);
													?>
									...
									<div class="col-md-3" id="div_consignee">
										<div class="form-group form-group-material">
											...
											<div class="input-group">
												<select name="consigneeid" id="consigneeid" required  class="form-control">
													<option></option>
												</select>
												<span class="input-group-addon">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group form-group-material">
											...
											<div class="input-group">
												<select name="packagetype" id="packagetype" required class="form-control" onchange="return get_productRate(this.value, <?php echo $_SESSION['user_id']; ?>, '<?php echo $_SESSION['ip']; ?>');" onblur="return lrentry_disabled(this.value, 'packagetype');">
													<option></option>

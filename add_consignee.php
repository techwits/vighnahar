				...
				<div class="row">
								...
								<div class="panel-footer">
									<div class="col-md-12">
										<div class="text-right">
											<button type="button" name="submit" id="submit" class="btn btn-primary heading-btn pull-right" onclick="return add_consignee();"><span class="text-semibold" id="<?php echo $span_pageButton; ?>">Submit</span></button>
										</div>
									</div>
                    ...
                    <div class="col-lg-4">
						...
						<div class="panel panel-flat" style="border-color:<?php echo $Search_BorderColor; ?>; border-top-width:<?php echo $Search_BorderTopWidth; ?>;">
							...
							<!-- Basic datatable -->
							<div class="panel-heading" id="div_searchconsignee">
								<?php include('add_consignee_2.php'); ?>
							<div/>
							<!-- /basic datatable -->
						</div>

				...
				<div class="content">
					...
					<form name="change_password" id="change_password">
						<div class="panel panel-body login-form">
							...
							<div class="panel panel-body" id="div_userid">
								...
								<div class="form-group">
									<button type="button" class="btn btn-primary btn-block" onclick="return changepassword_checkuserid();">Check User <i class="icon-circle-right2 position-right"></i></button>
								</div>
							</div>
						</div>
					</form>

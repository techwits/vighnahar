                                  	...
                                  	<div class="panel-body">
                                          <div class="row">
                                              <div class="col-xs-12 ">
                                                  ...
                                                  <div class="col-xs-2 text-center">
                                                      <span class="heading-text badge bg-teal-800"> 53 </span>
                                                      <div class="text-muted text-size-small">Delivered</div>
                                                  </div>
                                                  <div class="col-xs-2 text-center">
                                                      <span class="heading-text badge bg-teal-800"> 53 </span>
                                                      <div class="text-muted text-size-small">Undelivered</div>
                                                  </div>
                                                  <div class="col-xs-2 text-center">
                                                      <span class="heading-text badge bg-teal-800"> 53 </span>
                                                      <div class="text-muted text-size-small">Edited</div>
                                                  </div>
                                                  <div class="col-xs-2 text-center">
                                                      <span class="heading-text badge bg-teal-800"> 53 </span>
                                                      <div class="text-muted text-size-small">Deleted</div>
                                                  </div>
                                                  <div class="col-xs-2 text-center">
                                                      <span class="heading-text badge bg-teal-800"> 53 </span>
                                                      <div class="text-muted text-size-small">No RM</div>
                                                  </div>
                                              </div>
                                          </div>
                                        </div>
                  ...
                  <div class="sidebar-content">
                      ...
                      <div class="sidebar-category">
                          ...
                          <ul class="navigation navigation-alt navigation-accordion">
                            ...
                            <li><a href="#" onclick="window.open('add_undeliveredreason.php','_self');"><i class="icon-location4"></i> Delivery status <span class="badge badge-success">165</span></a></li>
                          </ul>
                      </div>
                      <!-- /actions -->

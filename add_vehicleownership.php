...
<head>
	...
	<title>Vehicale Ownership Entry</title>
...
<body>
	...
	<!-- Main navbar -->
	<?php
		$PageHeaderName="Add Vehicle Ownership";
			...
			<div class="content-wrapper">
				...
				<div class="row">
					<div class="col-sm-8 col-md-8 col-lg-8">
						<form name="vehicleownershipmenu_form" id="vehicleownershipmenu_form" action="#">
										...
										<div class="col-lg-6">
											<div class="form-group form-group-material">
												...
												<div class="input-group">
													<input type="text" class="form-control" name="vehicleownershipname" id="vehicleownershipname"  required="required" autofocus onkeypress="return only_Alpha_Numeric_underscore_dot(event);" ondrop="return false;" onpaste="return false;">
								...
								<div class="panel-footer">
									<div class="col-md-12">
										<div class="text-right">
											...
											<button type="submit" class="btn btn-primary" onclick="return add_vehicleownership();">Submit <i class="icon-arrow-right14 position-right"></i></button>
                    ...
                    <div class="col-lg-4">
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								...
								<?php include('add_vehicleownership_1.php'); ?>

							
							<!-- Basic datatable -->
							<div class="panel-heading" id="div_searchvehicleownership">
								<?php include('add_vehicleownership_2.php'); ?>
							<div/>
							<!-- /basic datatable -->
						</div>

...
//        die();
        ...
        if (mysqli_num_rows($result)!=0)
        {
            while ($row = mysqli_fetch_array($result,MYSQLI_NUM))
            {
                ...
                ?>
                <tr>
                    <td><a href="#" onclick="return editlogin(<?php echo $loginid; ?>, '<?php echo $CreationDate; ?>', '<?php echo $ModificationDate; ?>', '<?php echo $Creator; ?>', '<?php echo $ip; ?>', '<?php echo $UserName; ?>', '<?php echo $UserID; ?>', '<?php echo $last_login; ?>', '<?php echo $Active; ?>');"><?php echo $UserName; ?></a> </td>
                    <td>Sachin</td>
                    <td>12</td>

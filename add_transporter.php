...
<body class="navbar-top">
	...
	<!-- Main navbar -->
	<?php
		$PageHeaderName="Add Transporter";
			...
			<div class="content-wrapper">
				...
				<div class="row">
					<div class="col-sm-8 col-md-8 col-lg-8">
						<form name="transport_form" id="transport_form" action="#">
									...
									<div class="row">
										...
										<div class="col-lg-3">
											<div class="form-group">
												...
												<select name="vehiclename" id="vehiclename" class="select-search select2-hidden-accessible" tabindex="-1" aria-hidden="true">
													<option></option>
													<?php
										...
										<div class="col-lg-3">
											<div class="form-group form-group-material">
												...
												<div class="input-group">
													<input type="text" class="form-control" name="transportername" id="transportername"  required="required" onkeypress="return only_Alpha_Numeric_underscore_dot(event);" ondrop="return false;" onpaste="return false;">
										...
										<div class="col-lg-3">
											<div class="form-group form-group-material">
												...
												<div class="input-group">
													<input type="text" class="form-control" name="mobilenumber" id="mobilenumber"  required="required" autofocus onkeypress="return only_Numeric_Comma(event);" ondrop="return false;" onpaste="return false;">
                                                        <span class="input-group-addon">
                                                    <i class="icon-user"></i>
                                                    </span>
												</div>
										...
										<div class="col-lg-3">
											<div class="form-group form-group-material">
												...
												<div class="input-group">
													<input type="text" class="form-control" name="licencenumber" id="licencenumber"  required="required" autofocus onkeypress="return only_Alpha_Numeric_underscore_dot(event);" ondrop="return false;" onpaste="return false;">
                                                        <span class="input-group-addon"
                                                    <i class="icon-user"></i>
                                                    </span>
												</div>
										...
										<div class="col-lg-3">
											<div class="form-group form-group-material">
												...
												<div class="input-group">
													<textarea cols="100" rows="3" name="remark" id="remark"></textarea>
									...
									<div class="panel-footer">
										<div class="col-md-12">
											<div class="text-right">
												<button type="submit" name="submit" id="submit" class="btn bg-grey-600" onclick="return add_transporter();"><span class="text-semibold" id="<?php echo $span_pageButton; ?>">Submit</span></button>
											</div>
										</div>

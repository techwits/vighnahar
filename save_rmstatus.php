...
//        mysqli_close($con);
    ...
    if(trim($error_msg)=="") {
        if ($AddEdit == 0) {
            $Procedure = "Call Update_Outward('$CurrentDate', $session_userid, '$session_ip', $OutwardLRID, $DeliveredID, $UnDeliveredID);";
        }
...
//            die();
            ...
            if($UnDeliveredID>0){
                    ?><span class="label label-danger">Undelivered</span><?php
                }
                else{

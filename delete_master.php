        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-sm-8 col-md-8 col-lg-8 col-lg-8 col-lg-offset-2">
                    <form name="deletemaster_form" id="deletemaster_form" action="#">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="mastertable" id="mastertable" class="form-control" onchange="Fill_MasterColumn(this.value);">
                                                <option></option>
                                                <?php
                                                    Fill_MasterPageList($con);
                                                ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div id="div_fillmasterrecords"  class="form-group form-group-material">
                                            <label>Product</label>
                            ...
                            <div class="panel-footer">
                                <div class="col-md-12">
                                    <div class="text-right">
                                        <button type="button" name="submit" id="submit" class="btn bg-grey-600" onclick="return delete_master();"><span class="text-semibold" id="<?php echo $span_pageButton; ?>">Submit</span></button>
                                    </div>
                                </div>
                                <div id="div_deletemaster"></div>
                            </div>
                        </div>
                    </form>
                </div>

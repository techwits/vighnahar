...
<body class="navbar-top">
	...
	<!-- Main navbar -->
	<?php
		$PageHeaderName="Manage Undelivered Reason";
			...
			<div class="content-wrapper">
				...
				<div class="row">
					<div class="col-sm-8 col-md-8 col-lg-8">
						<form name="undeliveredreason_form" id="undeliveredreason_form" action="#">
										...
										<div class="col-lg-6 col-lg-offset-3">
											<div class="form-group form-group-material">
												...
												<div class="input-group">
													<input type="text" class="form-control" name="reasonname" id="reasonname" autofocus required="required" onkeypress="return only_Alpha_Numeric_Space(event);" ondrop="return false;" onpaste="return false;">
								...
								<div class="panel-footer">
									<div class="col-md-12">
										<div class="text-right">
											<button type="button" name="submit" id="submit" class="btn btn-primary heading-btn pull-right" onclick="return add_undeliveredreason();"><span class="text-semibold" id="<?php echo $span_pageButton; ?>">Submit</span></button>
										</div>
									</div>
									<div id="div_undeliveredreason"></div>
								</div>
